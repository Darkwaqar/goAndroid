...
//    private RecyclerView bannerRecyclerView;
    ...
    private AspectRatioImageView firstBanner;
...
//        bannerRecyclerView = (RecyclerView) view.findViewById(R.id.banner_RecyclerView);
        ...
        firstBanner = (AspectRatioImageView) view.findViewById(R.id.first_banner);
...
//        indicator2 = view.findViewById(R.id.indicator2);
        ...
        categoryRecyclerViewAdapter = new SimpleRecyclerViewAdapter(getActivity(), categories,GoMobileApp.getScreenWidth() / 100 *60);
        RecyclerView.LayoutManager mLayoutManager =
                new LinearLayoutManager(getActivity(), LinearLayoutManager.HORIZONTAL, false);
        ...
        discoverCategoryRecycler.hasFixedSize();


        GoMobileApp.getmCacheManager().loadImage(Uri.parse(AppConstant.FIRST_BANNER_IMAGE_URL), firstBanner);
        GoMobileApp.getmCacheManager().loadImage(Uri.parse(AppConstant.SECOND_BANNER_IMAGE_URL), secondBanner);
...
//        }));
        ...
        Uri video = Uri.parse(AppConstant.VIDEO_URL1);
